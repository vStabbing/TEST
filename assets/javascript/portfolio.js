...
(function () {
    ...
    $(document).ready(function () {
        var links = [
		    ...
		    {
                name: 'youtube',
                link: 'https://youtube.com/toggled'
            },
		    {
                name: 'spotify',
                link: 'https://open.spotify.com/user/31vunjkpfhfalsjufuadwhhmbsba?si=e2342deb2b0b445f'
            },
            {
                name: 'ezping',
                link: 'https://ezping.gg/'
            },
        ]; 
        for (var i in links) {
            var link = links[i];
    ...
    (function () {
        $.getJSON('https://api.ipgeolocation.io/ipgeo?apiKey=2bdc619693544329841a3196dca3f6c0', function (data) { 
            ...
            writeLine(["Starting... Intializing.", "Trying to connect to <span style='font-size: 14px; color: #7F00FF;'>[stability.gq]</span>..."], 30, function () {
                ...
                writeLine(["Authentication Established <span style='font-size: 14px; color: #0f0;'>[success]</span>", "Loading website...."], 30, 501, function () {
                    ...
                    writeLine(["<i style='color: #FFFF00'>glad to have you here./i>"], 30, 500, function () {
